...
public class Token
{
    ...
    /** Identifier Classification for identifiers.
     * Some values for OPERANDS: EMPTY, PRIMITIVE, FIXED_ARRAY, UNBOUND_ARRAY
     */
    public IdenClassif idenClassif = IdenClassif.EMPTY;

    /** Expression precedence if token is operator, or valid separator
     */
    public int precedence = 0;

    /** stack precedence if token is operator, or valid separator
     */
    ...
    public ResultValue toResult() {
        ...
        res.terminatingStr = this.tokenStr;
        return res;
    }

    public int getPrecedence ( ){
        return (Scanner.hToken.get(tokenStr));
    }

    public int getStackPrecedence( ){
        return(Scanner.hStack).get(tokenStr);
    }
}
